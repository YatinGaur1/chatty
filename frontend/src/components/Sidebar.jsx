...
export const Sidebar = () => {
  ...
  const filteredUser=showOnlineUsersOnly? users.filter(user=>onlineUsers.includes(user._id)):users;
  ...
  return (
    <aside className="h-full w-20 lg:w-72 border-r border-base-300 flex flex-col transition-all duration-200">
      ...
      <div className="overflow-y-auto w-full py-3">
       ...
       {(filteredUser.length===0&&(!showOnlineUsersOnly))&&
       <div className="text-center text-zinc-500 py-4">No User Exit </div>
       }
